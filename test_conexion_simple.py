#!/usr/bin/env python3
"""
Script simple para probar la conexión con MongoDB Atlas
"""
    ...
    try:
        ...
        for coleccion in colecciones_importantes:
            if coleccion in colecciones:
                ...
                print(f"  OK {coleccion}: {count} documentos")
            else:
                print(f"  NO {coleccion}: NO ENCONTRADA")
        ...
        if "modulos" in colecciones:
            ...
            print("  NO Colección 'modulos' no encontrada")
        ...
        if "modulos" not in colecciones or db["modulos"].count_documents({}) < 10:
            ...
            print(f"OK Se crearon {len(resultado.inserted_ids)} módulos")
...
if __name__ == "__main__":
    ...
    if exito:
        ...
        print("RESULTADO: Módulos creados/verificados exitosamente")
    else:
